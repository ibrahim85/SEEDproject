...
Wrote a draft script, need to check the required field name and table
name and test.
\section{PM Excel file to template file converter}
created the modified template, 
created a new building in PM with meter data, 
write the converter tomorrow
\newpage
